...
no_wdw_histories = extract_histories_from_files_(no_wdw_path, no_wdw_file)
...
plt_fig = plot_ts_(no_wdw_mean_history, "red", "no sliding window", fig=plt_fig, linestyle=":", marker=",")
