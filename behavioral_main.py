...
# import sys
# import time
# from src.strategies.strategy_utils import main_blind_strategies, main_hard_coded_strategies, get_strategies, compute_behavioral_profile, get_strategies_by_names
...
# n_iterations = 100
# checkpoint = 100
# main_strategies = get_strategies_by_names("unfair_random")
#
# msg = ("Run UnfairRND against both RND and itself, and compute the behavioral profile in both cases."
#        f"The behavioral dimensions composing the behavioral profile are the following: {main_behavioral_dimensions.keys()}.")
#
# if msg == "":
...
#
#             behavioral_profile = compute_behavioral_profile(timestamp, game_histories, main_behavioral_dimensions, main_player_name=main_name, opponent_name=opponent_name)
