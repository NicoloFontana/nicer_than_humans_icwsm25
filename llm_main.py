...
checkpoint = 0
checkers = False
msg = "Run gpt3.5t vs URND[01,10] with history window size 10."
# coop_prob = 0.9
    ...
    for n_game in range(n_games):
        ...
        for iteration in range(n_iterations):
            ...
            if not game.is_ended:
                ...
                infix = f"{urnd_str}_{n_game + 1}_{curr_round}" if n_games > 1 else curr_round
        ...
        infix = f"{urnd_str}_{n_game + 1}" if n_games > 1 else None
