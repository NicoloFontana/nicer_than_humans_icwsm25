...
from src.games.two_players_pd_utils import extract_histories_from_files_
...
for strat_name in strats.keys():
    ...
    for i in range(0, 11):
        ...
        profile = compute_behavioral_profile_(game_histories, main_behavioral_features, history_main_name, history_opponent_name)
        profile.strategy_name = strat_name
        profile.opponent_name = opponent_name
        profile.save_to_file_(urnd_dir_path)
